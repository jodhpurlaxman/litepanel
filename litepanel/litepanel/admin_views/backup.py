...
from litepanel.models import BackupConfig, BackupJob
from litepanel.admin_views.decorators import admin_required
from litepanel.services.backup import run_backup, init_repo, list_snapshots, restore_snapshot
from litepanel.utils.encryption import encrypt_data
...
def list_backups(request):
    ...
    # Enrich configs with snapshot count if initialized
