    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('website', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='ftp_accounts', to='litepanel.website')),
            ],
            options={'app_label': 'litepanel'},
        ),
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('website', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='git_repos', to='litepanel.website')),
            ],
            options={'app_label': 'litepanel'},
        ),
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('website', models.OneToOneField(on_delete=django.db.models.deletion.CASCADE, related_name='ssl_certificate', to='litepanel.website')),
            ],
            options={'app_label': 'litepanel'},
        ),
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('created_at', models.DateTimeField(auto_now_add=True)),
                ('website', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='databases', to='litepanel.website')),
            ],
            options={'app_label': 'litepanel'},
        ),
        migrations.CreateModel(
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('config', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='jobs', to='litepanel.backupconfig')),
            ],
            options={'app_label': 'litepanel'},
        ),
        migrations.CreateModel(
