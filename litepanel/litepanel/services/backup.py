...
from litepanel.models import BackupConfig, BackupJob, Website
from litepanel.utils.encryption import decrypt_data
...
def _prepare_env(config):
    ...
    env["RESTIC_PASSWORD"] = creds.get("repo_password", "litepanel-default")
    return env
